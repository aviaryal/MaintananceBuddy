...
import kotlinx.android.synthetic.main.fragment_contact__us.*
...
class Contact_Us : Fragment() {
    ...
    private fun return_back_to_residentpage(){
        go_back_from_contact_us.setOnClickListener{
